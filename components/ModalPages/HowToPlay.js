    ...
    return (<>
        <Modal.Content>
            <p>
                ...
                Each player owns one store and half of the houses on the board.<br/><br/>Every turn, a player disperses the pieces from a house in a counter-clockwise motion 
                around the board; when they get to their store, they&apos;ll drop a piece in but they will ignore the other players store when they pass it.<br/><br/>The game finishes when one side of the board is cleared
